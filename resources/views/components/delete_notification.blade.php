<div x-data="{displayModal: false, action: false }" @delete-notify.window="displayModal = true; action = event.detail.action">
  <div
      ...
      >
        ...
        <div class="mt-4">
          ...
          <div class="space-x-3 mt-5">
              ...
              <button
                @click="displayModal = false; window.livewire.emit(action)"
                {{-- x-on:click="$wire.emit(action)" --}}
