    ...
    >
      ...
      >
        ...
        <div class="px-4 py-4 sm:px-5">
          <p>
              To add a office, please input the registered student's registration number and then select the 'Add Student' button.
          </p>
          <div class="mt-4 space-y-4">
              ...
              <div class="space-x-2 text-right">
                  ...
                  <button wire:click="addContestant()"
